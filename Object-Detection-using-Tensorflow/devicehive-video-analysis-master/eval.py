...
if __name__ == '__main__':
    tf.compat.v1.app.flags.DEFINE_string('video', 0, 'Path to the video file.')
    tf.compat.v1.app.flags.DEFINE_string('model_name', 'Yolo2Model', 'Model name to use.')

    tf.compat.v1.app.run(main=evaluate)
