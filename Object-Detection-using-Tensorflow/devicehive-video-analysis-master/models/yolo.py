...
tf.compat.v1.app.flags.DEFINE_float('score_threshold', .3, 'Score threshold.')
tf.compat.v1.app.flags.DEFINE_float('iou_threshold', .4, 'Intersection over union threshold.')
